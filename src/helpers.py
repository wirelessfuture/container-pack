...
def get_precision(precision):
    return Decimal("1.{}".format("0" * precision))


def set_to_decimal(value, precision):
    precision_to_use = get_precision(precision)

    return Decimal(value).quantize(precision_to_use)
